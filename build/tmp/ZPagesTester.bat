...
@rem ##########################################################################
@rem
@rem  ZPagesTester startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and Z_PAGES_TESTER_OPTS to pass JVM options to this script.
...
@rem Execute ZPagesTester
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %Z_PAGES_TESTER_OPTS%  -classpath "%CLASSPATH%" io.opencensus.examples.zpages.ZPagesTester %CMD_LINE_ARGS%
...
:fail
rem Set variable Z_PAGES_TESTER_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%Z_PAGES_TESTER_EXIT_CONSOLE%" exit 1
exit /b 1
