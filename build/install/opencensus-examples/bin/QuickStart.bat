...
@rem Add default JVM options here. You can also use JAVA_OPTS and QUICK_START_OPTS to pass JVM options to this script.
...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %QUICK_START_OPTS%  -classpath "%CLASSPATH%" io.opencensus.examples.helloworld.QuickStart %CMD_LINE_ARGS%
...
:fail
rem Set variable QUICK_START_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%QUICK_START_EXIT_CONSOLE%" exit 1
exit /b 1
