...
@rem ##########################################################################
@rem
@rem  Repl startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and REPL_OPTS to pass JVM options to this script.
...
@rem Execute Repl
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %REPL_OPTS%  -classpath "%CLASSPATH%" io.opencensus.examples.quickstart.Repl %CMD_LINE_ARGS%
...
:fail
rem Set variable REPL_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%REPL_EXIT_CONSOLE%" exit 1
exit /b 1
