...
@rem ##########################################################################
@rem
@rem  HelloWorldClient startup script for Windows
@rem
@rem ##########################################################################
...
@rem Execute HelloWorldClient
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %HELLO_WORLD_CLIENT_OPTS%  -classpath "%CLASSPATH%" io.opencensus.examples.grpc.helloworld.HelloWorldClient %CMD_LINE_ARGS%
