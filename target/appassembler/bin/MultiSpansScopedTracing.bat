...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="MultiSpansScopedTracing" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" io.opencensus.examples.trace.MultiSpansScopedTracing %CMD_LINE_ARGS%
