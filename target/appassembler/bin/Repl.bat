...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="Repl" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" io.opencensus.examples.quickstart.Repl %CMD_LINE_ARGS%
