...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="OcAgentExportersQuickStart" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" io.opencensus.examples.ocagent.OcAgentExportersQuickStart %CMD_LINE_ARGS%
