...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="LongGaugeQuickstart" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" io.opencensus.examples.gauges.LongGaugeQuickstart %CMD_LINE_ARGS%
