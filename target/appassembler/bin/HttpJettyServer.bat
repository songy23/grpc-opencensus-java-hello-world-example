...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="HttpJettyServer" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" io.opencensus.examples.http.jetty.server.HelloWorldServer %CMD_LINE_ARGS%
