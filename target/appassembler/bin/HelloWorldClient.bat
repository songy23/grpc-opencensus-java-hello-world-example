...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="HelloWorldClient" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" io.opencensus.examples.grpc.helloworld.HelloWorldClient %CMD_LINE_ARGS%
