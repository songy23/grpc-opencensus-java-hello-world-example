...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="HelloWorldServer" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" io.opencensus.examples.grpc.helloworld.HelloWorldServer %CMD_LINE_ARGS%
