...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="MultiSpansContextTracing" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" io.opencensus.examples.trace.MultiSpansContextTracing %CMD_LINE_ARGS%
