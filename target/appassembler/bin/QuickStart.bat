...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="QuickStart" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" io.opencensus.examples.helloworld.QuickStart %CMD_LINE_ARGS%
