...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="HttpJettyClient" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" io.opencensus.examples.http.jetty.client.HelloWorldClient %CMD_LINE_ARGS%
