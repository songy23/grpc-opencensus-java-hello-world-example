...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="TagContextExample" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" io.opencensus.examples.tags.TagContextExample %CMD_LINE_ARGS%
