...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="StackdriverQuickstart" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" io.opencensus.examples.stats.StackdriverQuickstart %CMD_LINE_ARGS%
