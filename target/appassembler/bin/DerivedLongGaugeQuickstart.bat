...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="DerivedLongGaugeQuickstart" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" io.opencensus.examples.gauges.DerivedLongGaugeQuickstart %CMD_LINE_ARGS%
